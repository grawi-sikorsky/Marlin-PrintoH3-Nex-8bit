...
#define MSG_SD_REMOVED                      _UxGT("Karta usuni�ta")
#define MSG_LCD_ENDSTOPS                    _UxGT("Kranc�w.") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu g��wne")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Nast�pny punkt")
...
#define MSG_MOVE_X                          _UxGT("Przesu� w X")
#define MSG_MOVE_Y                          _UxGT("Przesu� w Y")
#define MSG_MOVE_Z                          _UxGT("Przesu� w Z")
#define MSG_MOVE_E                          _UxGT("Ekstruzja (os E)")
#define MSG_MOVE_01MM                       _UxGT("Przesu� co .1mm")
#define MSG_MOVE_1MM                        _UxGT("Przesu� co 1mm")
#define MSG_MOVE_10MM                       _UxGT("Przesu� co 10mm")
#define MSG_SPEED                           _UxGT("Predko��")
#define MSG_BED_Z                           _UxGT("St� Z")
#define MSG_NOZZLE                          _UxGT("Dysza")
#define MSG_BED                             _UxGT("St�")
...
#define MSG_ACC                             _UxGT("Przy�pieszenie")
...
#define MSG_VELOCITY						_UxGT("Pr�dko�ci")
...
#define MSG_A_TRAVEL                        _UxGT("A-przesu�.")
...
#define MSG_FILAMENT_DIAM                   _UxGT("�r. fil.")
#define MSG_CONTRAST                        _UxGT("Kontrast LCD")
#define MSG_STORE_EEPROM                    _UxGT("Zapisz w pami�ci")
#define MSG_LOAD_EEPROM                     _UxGT("Wczytaj z pami�ci")
#define MSG_RESTORE_FAILSAFE                _UxGT("Ustaw. fabryczne")
#define MSG_REFRESH                         _UxGT("Odswie�")
#define MSG_WATCH                           _UxGT("Ekran g��wny")
...
#define MSG_FILAMENTCHANGE                  _UxGT("Zmie� filament")
...
#define MSG_ENDSTOP_ABORT                   _UxGT("B��d kra�c�wki")
...
#define MSG_PLEASE_RESET                    _UxGT("Prosz� zresetowa�")
...
#define MSG_BED_DONE                        _UxGT("Rozgrzano st�")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibruj �rodek")
...
#define MSG_INFO_BAUDRATE                   _UxGT("Predko�� USB")
#define MSG_INFO_PROTOCOL                   _UxGT("Protok�")
#define MSG_CASE_LIGHT                      _UxGT("O�wietlenie")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Uko�czono")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ekstruduj wi�cej")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Wzn�w drukowanie")
...
// printo3d info menu
#define	MSG_INFO_P3D_1						_UxGT("W razie problem�w")
#define	MSG_INFO_P3D_2						_UxGT("skontaktuj si�")
...
//#define									_UxGT("O nas")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("zmian� filamentu")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("wyj�cie filamentu")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W��z filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("i naci�nij przycisk")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("aby kontynuowa�...")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("ekstruzj� filamentu")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("wznowienie druku")

#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Prosz� czeka�...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Wysuwanie...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W�� i naci�nij prz.")
