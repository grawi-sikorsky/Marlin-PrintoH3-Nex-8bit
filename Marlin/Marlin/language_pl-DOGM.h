...
#define MSG_CASE_LIGHT                      _UxGT("Oświetlenie")
  ...
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Użyty filam.")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Ukończono")
...
//dodane Printo H3
#define MSG_PID_AUTOTUNE_START				_UxGT("PID rozpoczęto")
#define MSG_PID_AUTOTUNE_DONE				_UxGT("PID ukończono")
#define MSG_PID_AUTOTUNE_FAIL				_UxGT("PID błąd kalibracji")
#define MSG_PID_AUTOTUNE_OVERSHOT			_UxGT("PID błąd: overshot")
